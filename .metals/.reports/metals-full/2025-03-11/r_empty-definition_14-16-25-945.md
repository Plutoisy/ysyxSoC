error id: freechips/rocketchip/util/
file://<WORKSPACE>/rocket-chip/src/main/scala/util/SynchronizerReg.scala
empty definition using pc, found symbol in pc: freechips/rocketchip/util/
